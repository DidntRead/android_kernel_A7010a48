...
/*Lenovo-sw weimh1 add 2016-3-7 begin:add for accel*/
static struct platform_device *pltfm_dev;
/*Lenovo-sw weimh1 add 2016-3-7 end:add for accel*/
...
static struct acc_context *acc_context_alloc_object(void)
{
	...
	obj->accel_workqueue = alloc_workqueue("%s", WQ_HIGHPRI | WQ_UNBOUND | WQ_MEM_RECLAIM, 1, "accel_polling");
