...
#if defined(LSM6DS3_TILT_FUNC) || defined(LSM6DS3_STEP_COUNTER) || defined(LSM6DS3_SIGNIFICANT_MOTION)
...
static DRIVER_ATTR(layout, 0660, show_layout_value, store_layout_value);
...
#endif
	obj->hw = get_accel_dts_func(name, obj->hw);
