...
static bool enable_mtk_wlan_timeout_ws = true;
module_param(enable_mtk_wlan_timeout_ws, bool, 0644);
static bool enable_mtk_wlan_rx_ws = true;
module_param(enable_mtk_wlan_rx_ws, bool, 0644);
