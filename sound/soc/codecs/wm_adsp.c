...
#include "arizona.h"
#include "wm_adsp.h"
//kaka, add for buffer cmp to verify spi transmission.
//#define BUF_CMP    //zhangrc2 check performance
#ifdef BUF_CMP
...
#define WM_ADSP_FW_EZ2HEAR_WB_SPEAKER_TX    35
#define WM_ADSP_FW_EZ2HEAR_WB_HANDSET_TX	36
#define WM_ADSP_FW_EZ2HEAR_WB_HEADSET_TX    37
#define WM_ADSP_FW_EZ2HEAR_WB_SPEAKER_RX    38
#define WM_ADSP_FW_EZ2HEAR_WB_HANDSET_RX   39
#define WM_ADSP_FW_EZ2HEAR_WB_HEADSET_RX   40
#define WM_ADSP_FW_EZ2HEAR_WB_HEADPHONE_TX 41
#define WM_ADSP_FW_EZ2HEAR_WB_HEADPHONE_RX 42
#define WM_ADSP_NUM_FW            43
...
/*Add VOIP Setting*/
	...
	[WM_ADSP_FW_EZ2HEAR_WB_SPEAKER_TX] = "Ez2HearWBSpeaker Tx",
	[WM_ADSP_FW_EZ2HEAR_WB_HANDSET_TX] = "Ez2HearWBHandset Tx",
	[WM_ADSP_FW_EZ2HEAR_WB_HEADSET_TX] = "Ez2HearWBHeadset Tx",
	[WM_ADSP_FW_EZ2HEAR_WB_SPEAKER_RX] = "Ez2HearWBSpeaker Rx",
	[WM_ADSP_FW_EZ2HEAR_WB_HANDSET_RX] = "Ez2HearWBHandset Rx",
	[WM_ADSP_FW_EZ2HEAR_WB_HEADSET_RX] = "Ez2HearWBHeadset Rx",
	[WM_ADSP_FW_EZ2HEAR_WB_HEADPHONE_TX] = "Ez2HearWBHeadphone Tx",
	[WM_ADSP_FW_EZ2HEAR_WB_HEADPHONE_RX] = "Ez2HearWBHeadphone Rx",
};
...
/*Add VOIP Setting*/
	...
	[WM_ADSP_FW_EZ2HEAR_WB_SPEAKER_TX] = { .file = "ez2hear-sp-tx", .binfile = "ez2hear-wb-tx-speaker"},
	[WM_ADSP_FW_EZ2HEAR_WB_HANDSET_TX] = { .file = "ez2hear-hs-tx", .binfile = "ez2hear-wb-tx-handset"},
	[WM_ADSP_FW_EZ2HEAR_WB_HEADSET_TX] = { .file = "ez2hear-hs-tx", .binfile = "ez2hear-wb-tx-headset"},
	[WM_ADSP_FW_EZ2HEAR_WB_SPEAKER_RX] = { .file = "ez2hear-rx", .binfile = "ez2hear-wb-rx-speaker" },
	[WM_ADSP_FW_EZ2HEAR_WB_HANDSET_RX] = { .file = "ez2hear-rx", .binfile = "ez2hear-wb-rx-handset"},
	[WM_ADSP_FW_EZ2HEAR_WB_HEADSET_RX] = { .file = "ez2hear-rx", .binfile = "ez2hear-wb-rx-headset"},
	[WM_ADSP_FW_EZ2HEAR_WB_HEADPHONE_TX] = { .file = "ez2hear-hs-tx", .binfile = "ez2hear-wb-tx-headphone"},
	[WM_ADSP_FW_EZ2HEAR_WB_HEADPHONE_RX] = { .file = "ez2hear-rx", .binfile = "ez2hear-wb-rx-headphone"},
};
...
static int wm_adsp_load(struct wm_adsp *dsp)
{
	...
	while (pos < firmware->size &&
		...
		if (reg) {
			size_t to_write = WM_PAGE_SIZE;
			size_t remain = le32_to_cpu(region->len);
			const u8 *data = region->data;

			while (remain > 0) {
				if (remain < WM_PAGE_SIZE)
					to_write = remain;
			...
			int j,i;
			const char *bufprint1= buf->buf;
			const char *bufprint2= buf1->buf;
...
#ifdef PWM_SPI_DEBUG
    t1=sched_clock();
    printk("%s:%d: arizona The time pwm dw firmware t1-t0=%llu\n",__func__, __LINE__, t1-t0);
#endif
...
#ifdef PWM_SPI_DEBUG
    printk("arizona load coffienct t0 clk\n");
    t0=sched_clock();
#endif
...
#ifdef PWM_SPI_DEBUG
    t1=sched_clock();
    printk("arizona The time load coffienecet dw firmware t1-t0=%llu\n",t1-t0);
#endif
out_fw:
		   ...
		   int event)
{
	...
	case SND_SOC_DAPM_POST_PMU:
		...
		/* regmap read,cost time,can be removed */
#if 0
